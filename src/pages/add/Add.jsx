    ...
    if (page === 0) {
      ...
      return (
        <BasicPackageSection
          state={state}
          handleChange={handleChange}
          handleFeature_basic={handleFeature_basic}
          dispatch={dispatch}
        />
      );
    } else if (page === 3) {
      return (
        <StandardPackageSection
          state={state}
          handleChange={handleChange}
          handleFeature_standard={handleFeature_standard}
          dispatch={dispatch}
        />
      );
    } else if (page === 4) {
      return (
        <PremiumPackageSection
          state={state}
          handleChange={handleChange}
          handleFeature_premium={handleFeature_premium}
          dispatch={dispatch}
        />
      );
    } else if (page === 5) {
  ...
  return (
    <div className="add bg-light">
      ...
      <div className="form text-center">
        <div className="header fs-1 fw-500 mb-6">{FormTitles[page]}</div>
        ...
        <div className="footer">
          ...
          >
            {page === FormTitles.length - 1 && !isEdit
              ? "Create Gig"
              : page === FormTitles.length - 1 && isEdit
              ? "Update Gig"
              : "Next"}
